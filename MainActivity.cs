    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            btnAlmacenar.Click += async delegate
            {
                try
                {
                    var CuentadeAlmacenamiento = CloudStorageAccount.Parse //aqui va tu cadena de conexión
                    ...
                    clientes.Domicilio = txtDom.Text;
                    ...
                    var Carpeta = ClienteBlob.GetContainerReference("pablo");
